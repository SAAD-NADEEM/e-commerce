...
function FaceBookIcon() {
  return (
    <div className="scale-90 text-text-primary bg-main-background p-2 pr-1 rounded-full hover:bg-main-primary hover:text-main-background duration-100">
      <svg
        width="14"
        height="12"
        viewBox="0 0 14 12"
...
function InstaIcon() {
  return (
    <div className="scale-90 text-text-primary bg-main-background  rounded-full p-2 hover:bg-main-primary hover:text-main-background duration-100">
      <svg
        width="14"
        height="12"
        viewBox="0 0 14 14"
...
function MyAcount() {
  return (
    <div>
      <h3 className="text-sm md:text-base font-bold mb-1 text-main-secondary">
        My Account
      </h3>
      <nav className="flex flex-col gap-1">
        <Link href={"/"} className="text-xs text-main-background">
          Order List
        </Link>
        <Link href={"/"} className="text-xs text-main-background">
          Wishlist
...
function Footer() {
  return (
    <footer>
      <div className="bg-text-primary max-w-[1440px] justify-between mx-auto mt-10 md:mt-20">
        <section className="flex flex-col md:flex-row pt-4 md:pr-6 gap-4 p-3 md:p-4 justify-between">
